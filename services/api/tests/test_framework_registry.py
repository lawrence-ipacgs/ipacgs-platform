...
async def test_activating_a_version_does_not_touch_other_frameworks_versions(
    ...
    financial = await register_framework(
        db_session, code="FIN-GOV", name="Financial Governance", description=None, actor="alice"
    )
